 ...
 *  - <OpenLayers.Tile>
 */
OpenLayers.Tile.Vector = OpenLayers.Class(OpenLayers.Tile, {
    ...
    /** 
     * Property: gCont
     * {SVGGElement} The g element container of the tile.
     */
    gCont: null,
    ...
    /** 
     * Property: tileReloadAttempts
     * {Integer} Attempts to load the tile.
     */
   tileReloadAttempts: null,
    ...
    initialize: function(layer, position, bounds, url, size, options) {
        ...
        /*if (this.maxGetUrlLength != null || this.layer.gutter) {
            // only create frame if it's needed
            this.frame = document.createElement("g");
