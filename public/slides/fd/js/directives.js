        ...
        return{
            ...
            link:function(scope,element,attrs){
                ...
                var mapOpt={
                    ...
                    center:new OpenLayers.LonLat(-80.1890265,25.8148407).transform(fromProjection,toProjection),
                ...
                nLayer=new OpenLayers.Layer.OSM('U4M',[
                    ...
                    nLayer=new OpenLayers.Layer.Google("Google Streets", {visibility: false})
